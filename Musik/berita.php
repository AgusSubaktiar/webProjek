...
<?php
echo "<br><br>".strip_tags(substr($tampil['isi_berita'],0,200))."<b>"." ........"."<br><p align=right><a href=?url&act=Selanjutnya&data=$tampil[id_berita]>&nbsp;Read more</a></b></p><br>";
$no++;
...
$data=$_GET['data'];
include "config/koneksi.php";
$tampilinsemuanya=mysql_query("SELECT * FROM tb_berita WHERE id_berita = '$data'");
if($tampilin =mysql_fetch_array($tampilinsemuanya)){
	$id_beritas=$tampilin['id_berita'];
}
?> 
...
?><p align="left"><img src="foto/berita/<?php echo "$tampilin[gambar]"; ?>" width="500" height="200" </p>
